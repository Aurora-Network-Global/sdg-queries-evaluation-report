...
\begin{figure}[H]
  ...
  \includegraphics[width=0.75\textwidth]{figures/precisionbarchart.pdf}
	...
	v4: mean=62.87 standard deviation=16.54 \hspace{\textwidth} v5: mean=70.05 standard deviation=14.12}
}
...
v4 recall: Mean=14.63, Standard deviation=15.44 \hspace{\textwidth}
